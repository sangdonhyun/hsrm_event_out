...
"sndeTlphOfno":"1588",
"sendCont":"1",
"ntfcKindCode":"ZAU9001",
"btchPrcsYn":"1",
"sbsnSendYn":"N",
"ntfcTmplCode":"ACC00214",
"hpTlphTlcmNo":"010",
"jobMsgeCntn":"[한화생명] 보험료 납입 관련 안내전화 예정.",
"sndeTlphInno":"6363",
"onlnBtchDvsnCode":"R",
"msgeTitlNm":"[한화생명] 보험료 미납 안내전화 예정",
"hpTlphOfno":"4726",
"custId":"0000099995"},
"header":{"chnlTypeCode":"SVR",
"rspnDvsnCode":"S",
"rndmNo":"9619",
"userTmunIdnfVal":"",
"trnmSysCode":"MLO",
...
"serverType":"P",
"baseCrny":"KRW",
"tlgrCretDttm":"20220622171355506",
"custId":"",
"ctfnTokn":"",
"itfcId":"HLIMLO00005",
"hsno":"1",
...
"""
        ...
        hpTlphSbno = tel_list[2]
        ntfcKindCode = msg_info['serial_number']
        ntfcTmplCode = msg_info['event_code']
        hpTlphTlcmNo = tel_list[0]
        jobMsgeCntn = msg_info['msg_desc']
        msgeTitlNm = msg_info['msg_desc']
        hptlphofno = tel_list[1]
        trnmsyscode = "MLO"
        ipaddr = "010001054042"
        rqstDttm = self.format_time(msg_info['event_date'])
        rqsrIp = self.get_ip_12()
        serverType = "P"
        ...
        json_data['payload']['ntfcKindCode'] = ntfcKindCode
        json_data['payload']['ntfcTmplCode'] = ntfcTmplCode
        json_data['payload']['hpTlphTlcmNo'] = hpTlphTlcmNo
        json_data['payload']['jobMsgeCntn'] = jobMsgeCntn
        json_data['payload']['msgeTitlNm'] = msgeTitlNm
        json_data['header']['trnmsyscode'] = trnmsyscode
        json_data['header']['ipAddr'] = ipaddr
        json_data['header']['rqstDttm'] = rqstDttm
        json_data['header']['rqsrIp'] = rqsrIp
        json_data['header']['serverType'] = serverType
        json_data['header']['tlgrCretDttm'] = tlgrCretDttm
        json_data['header']['itfcId'] = itfcId
